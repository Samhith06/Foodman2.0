...
import personsvg from '../../assets/icons/person (2).svg';
    ...
    return <div className="min-h-screen bg-gray-50">
        ...
        <div className="px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 sm:p-8">
                    <form onSubmit={handleSignup} className="space-y-6">
                        ...
                        <div className="flex items-stretch border border-[#fc7f09] rounded-l-[10px] rounded-r-md hover:border-2 duration-100 ease-in">
                            <label className='flex items-center px-3 py-2 text-base font-normal leading-6 text-[#2E2B41] text-center whitespace-nowrap bg-[#fc7f09] rounded-l-[10px]'>
                                <img src={personsvg} alt="person" className="w-5 h-5 sm:w-6 sm:h-6" />
                            </label>
                            <input
                                type="text"
                                value={username}
                                ...
                                className="
                                    block w-full 
                                    px-3 py-2 
                                    text-sm sm:text-base font-normal leading-6 
                                    text-[#2E2B41] 
                                    rounded-r-md
                                    border-2 border-[#F3F0FF] border-l-0
                                    bg-[#F3F0FF]
                                    focus:outline-none focus:ring-2 focus:ring-[#fc7f09] focus:border-transparent
                                "
                            />   
                        </div>
                        ...
                        <div className="flex items-stretch border border-[#fc7f09] rounded-l-[10px] rounded-r-md hover:border-2 duration-100 ease-in">
                            <label className='flex items-center px-3 py-2 text-base font-normal leading-6 text-[#2E2B41] text-center whitespace-nowrap bg-[#fc7f09] rounded-l-[10px]'>
                                <img src={Call} alt="phone" className="w-5 h-5 sm:w-6 sm:h-6" />
                            </label>
                            <input
                                type="tel"
                                value={PhoneNumber}
                        ...
                        <div className="flex items-center mt-4">
                            <input
                                type="checkbox"
                                id="terms"
                                className="h-4 w-4 text-[#fc7f09] border-gray-300 rounded focus:ring-[#fc7f09]"
                                required
                            />
                            <label htmlFor="terms" className="ml-2 text-sm sm:text-base text-gray-600">
                                I agree to the <a href="/terms" className="text-[#fc7f09] hover:underline">Terms and Conditions</a>
                            </label>
                        </div>
                        {/* Buttons Container */}
            ...
            <p className="text-center text-sm sm:text-base lg:text-lg mt-6 px-4">
                ...
                <a href="/login" className="text-[#fc7f09] hover:underline ml-1">
                    Login here
                </a>
            </p>
        </div>
