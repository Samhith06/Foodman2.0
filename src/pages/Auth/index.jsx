      ...
      <div className="px-4 py-8 sm:px-6 lg:px-8 xl:px-12">
        ...
        <div className="text-center mb-8 lg:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
            Welcome to <span className="text-[#fc7f09]">FoodMan</span>
          </h1>
          <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Join thousands of food lovers and discover amazing dishes delivered
            right to your door.
          </p>
        </div>
          ...
          <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 lg:p-10 border border-gray-100">
            <form onSubmit={handleSignup} className="space-y-6">
              ...
              <div className="flex items-center mt-4">
                ...
                >
                  I agree to the{" "}
                  <a href="/terms" className="text-[#fc7f09] hover:underline">
        ...
        <div className="text-center mt-8 px-4">
          <p className="text-sm sm:text-base text-gray-600">
            ...
            <a
              href="/login"
              className="text-[#fc7f09] hover:text-[#e56f00] font-semibold hover:underline transition-colors duration-200"
            >
              Sign in here
            </a>
          </p>
